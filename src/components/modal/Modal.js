                    ...
                    <div className="mutiview-dialog-content">
                        ...
                        <div className="view reset-password-verification right">
                            <form>
                                <div className="input-wrapper">
                                    <input type="text" name="account" className="account" placeholder="手机号或邮箱" required="" />
                                </div>
                                ...
                                <div className="submit-wrapper">
                                    <button className="submit blue-button">获取验证码</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div className="view reset-password right">
                            <form>
                                ...
                                <div className="input-wrapper verification-code">
                                    <input type="text" name="verification_code" placeholder="邮箱收到的 6 位数验证码" required="" />
                        ...
                        <div className="view sms-login right">
                            <form>
                                ...
                                <div className="input-wrapper verification-code">
                                    <input type="text" name="verification_code" placeholder="6 位数验证码" required="" />
                                    <button type="button" className="send-code disabled">60 秒后重发</button>
                                </div>
                                <div className="submit-wrapper">
